...
public class ProjectController {
	...
	@GetMapping("/list")
	public ResponseEntity<List<Project>> getProjects(@RequestParam(value = "userId", required = true) Long userId) throws Exception {
	...
	@PostMapping("/users")
	public ResponseEntity<List<Map<String, Object>>> getProjectUsers(@RequestBody Map<String, Object> data) throws Exception {
